...
$route['register'] = 'c_front/register';
...
$route['admin/editakun'] = 'c_admin/editakun';
...
$route['kalab'] = 'c_kalab';
$route['kalab/listta'] = 'c_kalab/listta';
$route['kalab/listpengajuanproposal'] = 'c_kalab/listpengajuanproposal';
$route['kalab/aformta'] = 'c_kalab/aformta';
$route['kalab/setting'] = 'c_kalab/setting';
$route['kalab/datadosen'] = 'c_kalab/datadosen';
$route['kalab/tambahdosen'] = 'c_kalab/tambahdosen';
$route['mhs'] = 'c_mhs';
$route['mhs/formproposal'] = 'c_mhs/formproposal';
$route['mhs/listta'] = 'c_mhs/listta';
$route['mhs/listpengajuanproposal'] = 'c_mhs/listpengajuanproposal';
$route['mhs/setting'] = 'c_mhs/setting';
