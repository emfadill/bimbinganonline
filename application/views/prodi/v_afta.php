                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group">
                        <div class="radio">
                          <label>
                            <input name="pembimbing" id="optionsRadios1" value="<?php echo $ta->nid1.'|'.$ta->pembimbing1; ?>" checked="" type="radio">
                            <?php echo $ta->pembimbing1; ?>
                          </label>
                        </div>
                        <div class="radio">
                          <label>
                            <input name="pembimbing" id="optionsRadios2" value="<?php echo $ta->nid2.'|'.$ta->pembimbing2; ?>" type="radio">
