                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-group">
                        <div class="radio">
                          <label>
                            <input name="pembimbing" id="optionsRadios1" value="<?php echo $kp->nid1.'|'.$kp->pembimbing1; ?>" checked="" type="radio">
                            <?php echo $kp->pembimbing1; ?>
                          </label>
                        </div>
                        <div class="radio">
                          <label>
                            <input name="pembimbing" id="optionsRadios2" value="<?php echo $kp->nid2.'|'.$kp->pembimbing2; ?>" type="radio">
