              ...
              <div class="box-body">
                <table class="table">
                    ...
                    <td>
                      ...
                      <div class="form-group">
                          <select class="form-control select2" name="pembimbing" data-placeholder="Dosen Pembimbing" style="width: 100%;">
                            ...
                            <option value="<?php echo $dosen->nid.'|'.$dosen->nama_dosen; ?>" <?php if ($nids == $dosen->nid) { echo "selected"; } ?>><?php echo $dosen->nama_dosen; ?></option>
                            <?php } ?>
                          </select>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" name="status_pra_sid" type="text" value="<?php echo $ta->status_pra_sid; ?>"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>Foto 3x4cm</td>
                    <td><input type="file" name="lampiran_foto" value="<?php echo $ta->lampiran_foto; ?>">  <img src="<?php echo base_url().'files/ta/'.$ta->lampiran_foto; ?>" width="128px"></td>
                  </tr>
                </table>
              </div>
