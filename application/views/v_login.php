  ...
  <div class="login-box-body">
    ...
    <?php echo form_open('proseslogin'); ?>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary pull-right" style="margin-left: 10px;" >Login</button>
          <a href="<?php echo base_url().'register'; ?>" class="btn bg-olive pull-right">Daftar</a>
        </div>
      </div>
    </div>
    <?php echo form_close(); ?>
