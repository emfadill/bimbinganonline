...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>mhs" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><img src="<?php echo base_url(); ?>asset/Utama-W.png" width="50%" height="50%"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="<?php echo base_url(); ?>asset/Utama-W.png" width="10%" height="10%"><b>  Bimbingan Proposal</b> Online</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="<?php if (isset($active_home)) {echo $active_home;} ?>"><a href="<?php echo base_url(); ?>mhs"><i class="fa fa-home"></i> <span>Home</span></a></li>
        <li class="<?php if (isset($active_list_peng)) {echo $active_list_peng;} ?>">
          <a href="<?php echo base_url(); ?>mhs/formproposal"><i class="fa fa-pencil"></i> <span>Pengajuan Proposal</span>
            <span class="">
              <i class=""></i>
            </span>
          </a>
