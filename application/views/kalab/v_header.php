  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="<?php if (isset($active_home)) {echo $active_home;} ?>"><a href="<?php echo base_url(); ?>kalab"><i class="fa fa-home"></i> <span>Home</span></a></li>
        <li class="<?php if (isset($active_list_peng)) {echo $active_list_peng;} ?>">
          <a href="<?php echo base_url(); ?>kalab/listpengajuanproposal"><i class="fa fa-pencil"></i> <span>List Pengajuan</span>
            <span class="">
              <i class=""></i>
            </span>
          </a>
